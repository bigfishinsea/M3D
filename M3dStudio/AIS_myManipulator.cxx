...
IMPLEMENT_STANDARD_HANDLE(AIS_myManipulator, AIS_InteractiveObject)
IMPLEMENT_STANDARD_RTTIEXT(AIS_myManipulator, AIS_InteractiveObject)

IMPLEMENT_HSEQUENCE(AIS_myManipulatorObjectSequence)
...
namespace
{
		...
		int theIndex)
	{
		...
		throw Standard_ProgramError("AIS_myManipulator - Invalid axis index");
	}
...
//purpose  : 
//=======================================================================
Handle(Prs3d_Presentation) AIS_myManipulator::getHighlightPresentation(const Handle(SelectMgr_EntityOwner)& theOwner) const
{
...
//purpose  : 
//=======================================================================
Handle(Graphic3d_Group) AIS_myManipulator::getGroup(const Standard_Integer theIndex, const AIS_ManipulatorMode theMode) const
{
...
//purpose  : 
//=======================================================================
AIS_myManipulator::AIS_myManipulator()
	: myPosition(gp::XOY()),
	myCurrentIndex(-1),
...
//purpose  : 
//=======================================================================
AIS_myManipulator::AIS_myManipulator(const gp_Ax2& thePosition)
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::SetPart(const Standard_Integer theAxisIndex, const AIS_ManipulatorMode theMode, const Standard_Boolean theIsEnabled)
{
	Standard_ProgramError_Raise_if(theAxisIndex < 0 || theAxisIndex > 2, "AIS_myManipulator::SetMode(): axis index should be between 0 and 2");
	switch (theMode)
	{
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::SetPart(const AIS_ManipulatorMode theMode, const Standard_Boolean theIsEnabled)
{
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::EnableMode(const AIS_ManipulatorMode theMode)
{
	if (!IsAttached())
	{
		return;
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::attachToBox(const Bnd_Box& theBox)
{
	if (theBox.IsVoid())
	{
		return;
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::adjustSize(const Bnd_Box& theBox)
{
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::Attach(const Handle(AIS_InteractiveObject)& theObject, const OptionsForAttach& theOptions)
{
	if (theObject->IsKind(STANDARD_TYPE(AIS_myManipulator)))
	{
		return;
	}

	Handle(AIS_myManipulatorObjectSequence) aSeq = new AIS_myManipulatorObjectSequence();
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::Attach(const Handle(AIS_myManipulatorObjectSequence)& theObjects, const OptionsForAttach& theOptions)
{
...
//purpose  : 
//=======================================================================
Handle(AIS_myManipulatorObjectSequence) AIS_myManipulator::Objects() const
{
	return Handle(AIS_myManipulatorObjectSequence)::DownCast(GetOwner());
}
...
//purpose  : 
//=======================================================================
Handle(AIS_InteractiveObject) AIS_myManipulator::Object(const Standard_Integer theIndex) const
{
	Handle(AIS_myManipulatorObjectSequence) anOwner = Handle(AIS_myManipulatorObjectSequence)::DownCast(GetOwner());

	Standard_ProgramError_Raise_if(theIndex < anOwner->Lower() || theIndex > anOwner->Upper(), "AIS_myManipulator::Object(): wrong index value");
...
//purpose  : 
//=======================================================================
Handle(AIS_InteractiveObject) AIS_myManipulator::Object() const
{
	return Object(1);
}
...
//purpose  : 
//=======================================================================
Standard_Boolean AIS_myManipulator::ObjectTransformation(const Standard_Integer theMaxX, const Standard_Integer theMaxY,
	const Handle(V3d_View)& theView, gp_Trsf& theTrsf)
{
	...
	{
		myStartTrsfs.Clear();
		Handle(AIS_myManipulatorObjectSequence) anObjects = Objects();
		for (AIS_myManipulatorObjectSequence::Iterator anObjIter(*anObjects); anObjIter.More(); anObjIter.Next())
		{
...
//purpose  :
//=======================================================================
Standard_Boolean AIS_myManipulator::ProcessDragging(const Handle(AIS_InteractiveContext)&,
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::StartTransform(const Standard_Integer theX, const Standard_Integer theY, const Handle(V3d_View)& theView)
{
	if (myHasStartedTransformation)
	{
		return;
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::StopTransform(const Standard_Boolean theToApply)
{
	...
	Handle(AIS_myManipulatorObjectSequence) anObjects = Objects();
	AIS_myManipulatorObjectSequence::Iterator anObjIter(*anObjects);
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::Transform(const gp_Trsf& theTrsf)
{
	if (!IsAttached() || !myHasStartedTransformation)
	{
		return;
...
//purpose  : 
//=======================================================================
gp_Trsf AIS_myManipulator::Transform(const Standard_Integer thePX, const Standard_Integer thePY,
	const Handle(V3d_View)& theView)
{
	gp_Trsf aTrsf;
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::SetPosition(const gp_Ax2& thePosition)
{
...
//=======================================================================
void AIS_myManipulator::updateTransformation()
{
	gp_Trsf aTrsf;
	...
	// since AIS_myManipulator::setLocalTransformation() implementation throws exception
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::SetSize(const Standard_ShortReal theSideLength)
{
	for (Standard_Integer anIt = 0; anIt < 3; ++anIt)
	{
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::SetGap(const Standard_ShortReal theValue)
{
	for (Standard_Integer anIt = 0; anIt < 3; ++anIt)
	{
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::DeactivateCurrentMode()
{
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::SetZoomPersistence(const Standard_Boolean theToEnable)
{
...
//purpose  :
//=======================================================================
void AIS_myManipulator::SetTransformPersistence(const Handle(Graphic3d_TransformPers)& theTrsfPers)
{
	Standard_ASSERT_RETURN(!myIsZoomPersistentMode,
		"AIS_myManipulator::SetTransformPersistence: "
...
//purpose  :
//=======================================================================
void AIS_myManipulator::setLocalTransformation(const Handle(TopLoc_Datum3D)& /*theTrsf*/)
{
	Standard_ASSERT_INVOKE("AIS_myManipulator::setLocalTransformation: "
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::Compute(const Handle(PrsMgr_PresentationManager3d)& thePrsMgr,
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::HilightSelected(const Handle(PrsMgr_PresentationManager3d)& thePM,
...
//purpose  :
//=======================================================================
void AIS_myManipulator::ClearSelected()
{
	DeactivateCurrentMode();
}
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::HilightOwnerWithColor(const Handle(PrsMgr_PresentationManager3d)& thePM,
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::ComputeSelection(const Handle(SelectMgr_Selection)& theSelection,
	const Standard_Integer theMode)
{
	//Check mode
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::Disk::Init(const Standard_ShortReal theInnerRadius,
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::Sphere::Init(const Standard_ShortReal theRadius,
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::Cube::Init(const gp_Ax1& thePosition, const Standard_ShortReal theSize)
{
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::Cube::addTriangle(const Standard_Integer theIndex,
...
//purpose  : 
//=======================================================================
void AIS_myManipulator::Sector::Init(const Standard_ShortReal theRadius,
	const gp_Ax1& thePosition,
...
//purpose  : 
//=======================================================================
AIS_myManipulator::Axis::Axis(const gp_Ax1& theAxis,
...
void AIS_myManipulator::Axis::Compute(const Handle(PrsMgr_PresentationManager)& thePrsMgr,
	const Handle(Prs3d_Presentation)& thePrs,
